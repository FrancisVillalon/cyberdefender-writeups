...
# RE101 (CyberDefenders · Medium)

**Summary:** A binary analysis exercise covering a range of encoding and encryption tricks — base64, JSFuck, brainfuck, a corrupted ZIP header, IDA stack strings, and a custom XOR-based cipher reversed with Python.

**Tools:** PE Studio, VS Code, HxD, IDA, Python
