...
__Packets in Spike of Traffic__
...
__Threat actor scanning target__
...
__Repeating short sessions with TLS__
...
__Successful ReturnStatus for Command__
...
__Copy last 3 queries parameter values__
...
__DOS executable magic bytes__
...
__DOS Executable being transmitted__
...
__HTTP requests made by target__
...
__Main code of `checking.ps1`__
...
__Script variables of `ichigo-lite.ps1`__
...
__Contents of `extracted_hosts.txt`__
...
__Main logic of `ichigo-lite.ps1`__
...
__Getting SHA256 hash of file__
...
__Executive Report from JOESandbox__
...
__Actor brute forcing password__
